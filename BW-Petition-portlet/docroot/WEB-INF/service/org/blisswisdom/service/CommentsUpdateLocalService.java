...
/**
 * Provides the local service interface for CommentsUpdate. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Danny
 * @see CommentsUpdateLocalServiceUtil
...
public interface CommentsUpdateLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CommentsUpdateLocalServiceUtil} to access the comments update local service. Add custom service methods to {@link org.blisswisdom.service.impl.CommentsUpdateLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
